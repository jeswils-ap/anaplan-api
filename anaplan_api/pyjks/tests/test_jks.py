...
class JksTests(AbstractTest):
    ...
    def test_rsa_1024(self):
        ...
        self.assertEqual(store.store_type, "jks")
        self.check_pkey_and_certs_equal(pk, jks.util.RSA_ENCRYPTION_OID, anaplan_api.pyjks.tests.expected.RSA1024.private_key, anaplan_api.pyjks.tests.expected.RSA1024.certs)

    def test_rsa_2048_3certs(self):
        store = jks.KeyStore.load(KS_PATH + "/jks/RSA2048_3certs.jks", "12345678")
        pk = self.find_private_key(store, "mykey")
        self.assertEqual(store.store_type, "jks")
        self.check_pkey_and_certs_equal(pk, jks.util.RSA_ENCRYPTION_OID, anaplan_api.pyjks.tests.expected.RSA2048_3certs.private_key, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs)

    def test_dsa_2048(self):
        store = jks.KeyStore.load(KS_PATH + "/jks/DSA2048.jks", "12345678")
        pk = self.find_private_key(store, "mykey")
        self.assertEqual(store.store_type, "jks")
        self.check_pkey_and_certs_equal(pk, jks.util.DSA_OID, anaplan_api.pyjks.tests.expected.DSA2048.private_key, anaplan_api.pyjks.tests.expected.DSA2048.certs)
    ...
    def test_certs(self):
        ...
        self.assertEqual(cert1.cert, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[0])
        self.assertEqual(cert2.cert, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[1])
        self.assertEqual(cert3.cert, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[2])
        self.assertEqual(store.store_type, "jks")
    ...
    def test_custom_entry_passwords(self):
        ...
        self.check_pkey_and_certs_equal(pk, jks.util.RSA_ENCRYPTION_OID, anaplan_api.pyjks.tests.expected.custom_entry_passwords.private_key, anaplan_api.pyjks.tests.expected.custom_entry_passwords.certs)

        cert = self.find_cert(store, "cert")
        self.assertEqual(cert.cert, anaplan_api.pyjks.tests.expected.custom_entry_passwords.certs[0])
    ...
    def test_non_ascii_jks_password(self):
        ...
        pk = self.find_private_key(store, "mykey")
        self.assertEqual(store.store_type, "jks")
        self.check_pkey_and_certs_equal(pk, jks.util.RSA_ENCRYPTION_OID, anaplan_api.pyjks.tests.expected.jks_non_ascii_password.private_key, anaplan_api.pyjks.tests.expected.jks_non_ascii_password.certs)
    ...
    def test_create_and_load_keystore_non_ascii_password(self):
        cert = jks.PrivateKeyEntry.new('mykey', anaplan_api.pyjks.tests.expected.jks_non_ascii_password.certs, anaplan_api.pyjks.tests.expected.jks_non_ascii_password.private_key)
    ...
    def test_create_and_load_non_ascii_alias(self):
        cert = jks.PrivateKeyEntry.new(u'\xe6\xe6\xe6\xf8\xf8\xf8\xe5\xe5\xf8\xe6', anaplan_api.pyjks.tests.expected.RSA1024.certs, anaplan_api.pyjks.tests.expected.RSA1024.private_key)
        store = jks.KeyStore.new('jks', [cert])
    ...
    def test_create_and_load_custom_entry_passwords(self):
        cert = jks.PrivateKeyEntry.new('mykey', anaplan_api.pyjks.tests.expected.custom_entry_passwords.certs, anaplan_api.pyjks.tests.expected.custom_entry_passwords.private_key)
        store = jks.KeyStore.new('jks', [cert])
        pk = self.find_private_key(store, "mykey")
        self.assertTrue(pk.is_decrypted())
        ...
        self.assertEqual(store2.store_type, "jks")
        self.check_pkey_and_certs_equal(pk2, jks.util.RSA_ENCRYPTION_OID, anaplan_api.pyjks.tests.expected.custom_entry_passwords.private_key, anaplan_api.pyjks.tests.expected.custom_entry_passwords.certs)

    def test_create_and_load_keystore_pkcs8_rsa(self):
        cert = jks.PrivateKeyEntry.new('mykey', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs, anaplan_api.pyjks.tests.expected.RSA2048_3certs.private_key)
        store = jks.KeyStore.new('jks', [cert])
        store_bytes = store.saves('12345678')
        store2 = jks.KeyStore.loads(store_bytes, '12345678')
        pk = self.find_private_key(store2, "mykey")
    ...
    def test_create_and_load_keystore_pkcs8_dsa(self):
        cert = jks.PrivateKeyEntry.new('mykey', anaplan_api.pyjks.tests.expected.DSA2048.certs, anaplan_api.pyjks.tests.expected.DSA2048.private_key)
        store = jks.KeyStore.new('jks', [cert])
        store_bytes = store.saves('12345678')
        store2 = jks.KeyStore.loads(store_bytes, '12345678')
        pk = self.find_private_key(store2, "mykey")
    ...
    def test_create_and_load_keystore_raw_rsa(self):
        cert = jks.PrivateKeyEntry.new('mykey', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs, anaplan_api.pyjks.tests.expected.RSA2048_3certs.raw_private_key, 'rsa_raw')
        store = jks.KeyStore.new('jks', [cert])
        store_bytes = store.saves('12345678')
        store2 = jks.KeyStore.loads(store_bytes, '12345678')
        pk = self.find_private_key(store2, "mykey")
    ...
    def test_create_and_load_keystore_trusted_certs(self):
        cert1 = jks.TrustedCertEntry(type='X.509', cert=anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[0], timestamp=1463338684456, alias='cert1')
        cert2 = jks.TrustedCertEntry(type='X.509', cert=anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[1], timestamp=1463338684456, alias='cert2')
        cert3 = jks.TrustedCertEntry(type='X.509', cert=anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[2], timestamp=1463338684456, alias='cert3')
        ...
        self.assertEqual(cert1_2.cert, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[0])
        self.assertEqual(cert2_2.cert, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[1])
        self.assertEqual(cert3_2.cert, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[2])

    def test_create_and_load_keystore_both_trusted_and_private(self):
        pk = jks.PrivateKeyEntry.new('mykey', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs, anaplan_api.pyjks.tests.expected.RSA2048_3certs.raw_private_key, 'rsa_raw')
        cert1 = jks.TrustedCertEntry.new('cert1', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[0])
        cert2 = jks.TrustedCertEntry.new('cert2', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[1])
        cert3 = jks.TrustedCertEntry.new('cert3', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[2])
        ...
        self.assertEqual(cert3_2.cert, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[2])
        self.assertEqual(store.store_type, "jks")
        self.check_pkey_and_certs_equal(pk2, jks.util.RSA_ENCRYPTION_OID, anaplan_api.pyjks.tests.expected.RSA2048_3certs.private_key, anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs)

    def test_new_keystore_duplicate_alias(self):
        cert1 = jks.TrustedCertEntry.new('cert1', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[0])
        cert2 = jks.TrustedCertEntry.new('cert1', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[1])
    ...
    def test_alias_lower_certificate(self):
        cert = jks.TrustedCertEntry.new('CERT', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs[0])
    ...
    def test_alias_lower_pkey(self):
        pkey = jks.PrivateKeyEntry.new('PKEY', anaplan_api.pyjks.tests.expected.RSA2048_3certs.certs, anaplan_api.pyjks.tests.expected.RSA2048_3certs.private_key)
...
class BksOnlyTests(AbstractTest):
    ...
    def _test_christmas_store(self, store, store_type):
        ...
        self.assertEqual(sealed_public.public_key_info, anaplan_api.pyjks.tests.expected.bks_christmas.public_key)
        ...
        self.check_pkey_and_certs_equal(sealed_private, jks.util.RSA_ENCRYPTION_OID, anaplan_api.pyjks.tests.expected.bks_christmas.private_key, anaplan_api.pyjks.tests.expected.bks_christmas.certs)
        ...
        self.assertEqual(cert.cert, anaplan_api.pyjks.tests.expected.bks_christmas.certs[0])
